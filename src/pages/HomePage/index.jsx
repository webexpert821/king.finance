      ...
      <div className="section section-1">
        ...
        <div className="container">
            ...
            <div className="button-area">
              <div className="rect-buttons-group">
                ...
                <div className="rect-buttons">
                  <div className="rect-button docs">Docs</div>
                  <div className="rect-button staking">Staking</div>
                </div>
              </div>
              <div className="button-group">
                <div className="btn-kingfloki"></div>
                <div className="btn-kingland"></div>
                <div className="btn-kingpad"></div>
              </div>
            </div>
          </div>
          <div className="background-video-section">
            ...
            <video
              className="tablet-background-video"
              playsInline
              loop
              autoPlay
              muted
            ...
            <div className="background-video-overlay">
              <div className="king-finance">
                ...
                <span style={{ fontFamily: "gotham-thin", marginLeft: "12px" }}>
                  Finance
                </span>
              </div>
        ...
        <div className="container">
          <div className="about-king">
            <div className="king-details">
              <p>
                Crowning DeFi. <span className="bold">KING</span> is the parent
                company in charge of the development of three of the most
                innovative services in decentralised finance. Our ecosystem is
                based on our ‘ internal circular economy ’, where our branches
                feed each other continuously and in a balanced way throughout
                the individual generation of funds.{" "}
              </p>
              <p>
                Immerse yourself within{" "}
                <span className="bold">KingPad, KingLand</span> and{" "}
        ...
        <div className="background-svg">
          ...
          <div className="section-3-container">
            ...
            <div className="king-logos">
              <div
                className="king-floki"
                onMouseOver={() => changeBg(1)}
                onMouseOut={() => changeBg(0)}
              ></div>
              <div
                className="king-pad"
                onMouseOver={() => changeBg(2)}
                onMouseOut={() => changeBg(0)}
              ></div>
              <div
                className="king-land"
                onMouseOver={() => changeBg(3)}
                onMouseOut={() => changeBg(0)}
              ></div>
            </div>
          </div>
        ...
        <div className="container container-4">
          ...
          <div className="game-section">
            ...
            >
              <img
                src={DeskNftGame}
                className="desktop-nft-game-gif"
                alt="nft-game-gif"
              />
              <img
                src={MobileNftGame}
                className="mobile-nft-game-gif"
                alt="nft-game-gif"
              />
          ...
          >
            <img
              src={DeskBoxKingpad}
              className="desktop-box-kingpad"
              alt="desktop-box-kingpad"
            />
            <img
              src={MobileBoxKingPad}
              className="mobile-box-kingpad"
              alt="mobile-box-kingpad"
            />
            <div className="background-overlay">
          ...
          >
            <img
              src={DeskBoxKingland}
              className="desktop-box-kingland"
              alt="desktop-box-kingland"
            />
            <img
              src={MobileBoxKingland}
              className="mobile-box-kingland"
              alt="mobile-box-kingland"
            />
            <div className="background-overlay">
